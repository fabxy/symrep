...
class GhostTuple(namedtuple("GhostTuple", ("live", "ghost"))):
    ...
    def __getitem__(self, index):
        ...
        if index == "live":
            ...
            return self.ghost
        elif isinstance(index, GhostTuple):
            return GhostTuple(
    ...
    def __getattr__(self, name):
        ...
        if name == "live":
            ...
            return self.ghost
        elif isinstance(name, GhostTuple):
            return GhostTuple(
                live=self.live[name.live],
                ghost=self.ghost[name.ghost],
            )
        else:
            return GhostTuple(
